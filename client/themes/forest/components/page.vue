<template lang="pug">
  v-app(v-scroll='upBtnScroll', :dark='$vuetify.theme.dark', :class='$vuetify.rtl ? `is-rtl` : `is-ltr`')
    ...
    v-navigation-drawer(
      ...
      :class='$vuetify.theme.dark ? `grey darken-4-d4` : `green`'
      dark
      app
      clipped
      ...
      vue-scroll(:ops='scrollStyle')
        nav-sidebar(:color='$vuetify.theme.dark ? `grey darken-4-d4` : `green`', :items='sidebarDecoded', :nav-mode='navMode')
        ...
        v-layout(row)
          v-flex.page-col-sd(
            ...
            v-card.page-toc-card.mb-5(v-if='tocDecoded.length')
              .overline.pa-5.pb-0(:class='$vuetify.theme.dark ? `green--text text--lighten-2` : `primary--text`') {{$t('common:page.toc')}}
            ...
            v-card.page-comments-card.mb-5(v-if='commentsEnabled && commentsPerms.read')
              .pa-5
                .overline.pb-2.green--text.d-flex.align-center(:class='$vuetify.theme.dark ? `text--lighten-3` : `text--darken-2`')
                  ...
                  //-   label
                  //-   x-small
                  //-   :color='$vuetify.theme.dark ? `green darken-3` : `green darken-2`'
                  //-   dark
                ...
                .d-flex
                  v-btn.text-none(
                    @click='goToComments()'
                    :color='$vuetify.theme.dark ? `green` : `green darken-2`'
                    outlined
                    style='flex: 1 1 100%;'
                    small
                    )
                    span.green--text(:class='$vuetify.theme.dark ? `text--lighten-1` : `text--darken-2`') {{$t('common:comments.viewDiscussion')}}
                  v-tooltip(right, v-if='commentsPerms.write')
                    template(v-slot:activator='{ on }')
                      v-btn.ml-2(
                        ...
                        v-icon(:color='$vuetify.theme.dark ? `green lighten-1` : `green darken-2`', dense) mdi-comment-plus
                ...
                v-tooltip(bottom)
                  template(v-slot:activator='{ on }')
                    v-btn(icon, tile, v-on='on', @click='print', :aria-label='$t(`common:page.printFormat`)')
                      v-icon(:color='printView ? `green` : `grey`') mdi-printer
